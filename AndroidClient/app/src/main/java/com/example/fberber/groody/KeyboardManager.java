...
public final class KeyboardManager {
	...
	public static final void cacheKeys(){
		HashMap<Keyboard, Key> hmCtrl 	= new HashMap<Keyboard, Key>(8);
		HashMap<Keyboard, Key> hmShift 	= new HashMap<Keyboard, Key>(8);
		HashMap<Keyboard, Key> hmAlt 	= new HashMap<Keyboard, Key>(8);
		HashMap<Keyboard, Key> hmWin 	= new HashMap<Keyboard, Key>(8);
		HashMap<Keyboard, Key> hmCapsLock 	= new HashMap<Keyboard, Key>(2);
		HashMap<Keyboard, Key> hmScrollLock = new HashMap<Keyboard, Key>(1);
		HashMap<Keyboard, Key> hmNumLock 	= new HashMap<Keyboard, Key>(2);
